...
export const INITIAL_GUIDE_DATA: GuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      description: {
        IT: "I bidoni della spazzatura si trovano in tre punti vicini alla struttura:\n\n• Punto 1 (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• Punto 2 (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• Punto 3 (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• PLASTICA E METALLI (Giallo)\n• CARTA E CARTONE (Blu)\n• VETRO (Verde)\n• ORGANICO (Marrone)\n• INDIFFERENZIATA (Grigio)",
        EN: "The trash bins are located at three points near the property:\n\n• Point 1 (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• Point 2 (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• Point 3 (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• PLASTIC AND METALS (Yellow)\n• PAPER AND CARDBOARD (Blue)\n• GLASS (Green)\n• ORGANIC (Brown)\n• GENERAL WASTE (Gray)",
        DE: "Die Mülltonnen befinden sich an drei Punkten in der Nähe der Unterkunft:\n\n• Punkt 1 (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• Punkt 2 (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• Punkt 3 (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• KUNSTSTOFF UND METALLE (Gelb)\n• PAPIER UND PAPPE (Blau)\n• GLAS (Grün)\n• BIOABFALL (Braun)\n• RESTMÜLL (Grau)",
        FR: "Les poubelles se trouvent à trois endroits près de la propriété :\n\n• Point 1 (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• Point 2 (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• Point 3 (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• PLASTIQUE ET MÉTAUX (Jaune)\n• PAPIER ET CARTON (Bleu)\n• VERRE (Vert)\n• ORGANIQUE (Marron)\n• DÉCHETS MÉNAGERS (Gris)",
        ES: "Los contenedores de basura se encuentran en tres puntos cerca de la propiedad:\n\n• Punto 1 (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• Punto 2 (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• Punto 3 (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• PLÁSTICO Y METALES (Amarillo)\n• PAPEL Y CARTÓN (Azul)\n• VIDRIO (Verde)\n• ORGÁNICO (Marrón)\n• RESIDUOS GENERALES (Gris)",
        BG: "Кофите за боклук се намират на три места близо до имота:\n\n• Точка 1 (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• Точка 2 (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• Точка 3 (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• ПЛАСТМАСА И МЕТАЛИ (Жълто)\n• ХАРТИЯ И КАРТОН (Синьо)\n• СТЪКЛО (Зелено)\n• ОРГАНИЧНИ (Кафяво)\n• ОБЩИ ОТПАДЪЦИ (Сиво)",
        HU: "A szemeteskukák három helyen találhatók az ingatlan közelében:\n\n• 1. pont (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• 2. pont (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• 3. pont (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• MŰANYAG ÉS FÉM (Sárga)\n• PAPÍR ÉS KARTON (Kék)\n• ÜVEG (Zöld)\n• SZERVES (Barna)\n• VEGYES HULLADÉK (Szürke)",
        PL: "Pojemniki na śmieci znajdują się w trzech miejscach w pobliżu obiektu:\n\n• Punkt 1 (Via Pizzoli)\nMaps: https://maps.app.goo.gl/rfnKf4TGskYaubuz9\n\n• Punkt 2 (Via Crispi)\nMaps: https://maps.app.goo.gl/LiiKbbUB5A9h2uu36\n\n• Punkt 3 (Via Trevisani)\nMaps: https://maps.app.goo.gl/dyS5qCCJFGATqjMM7?g_st=ac\n\n• PLASTIK I METAL (Żółty)\n• PAPIER I TEKTURA (Niebieski)\n• SZKŁO (Zielony)\n• ODPADY BIO (Brązowy)\n• ZMIESZANE ODPADY (Szary)"
      }
    },
    {
      id: "supermarkets",
